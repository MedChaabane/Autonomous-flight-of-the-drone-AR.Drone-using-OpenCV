...
import traceback
import numpy 
import camShiftHelper 
import circleDetectorHelper 
import droneDummy
import os
import pygame
...
def fly():
	...
	print("stage=",stage)
        ...
        if (frame != None):
            if (keyPressed == False):
                if (stage==1):
                    (success,frame,counter,centerX,centerY,radius,inbox_width_and_height) = circleDetectorHelper.detectCircle(counter,frame,centerX,centerY,radius)
                    ...
                    if success:
                        ...
                        camShiftHandler = camShiftHelper.CamShift(centerX,centerY,inbox_width_and_height,inbox_width_and_height,frame, follow_light, useOpenCV3)
